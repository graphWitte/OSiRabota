...
## 5. Ассемблер
Файл `math_func.cpp` сгенерирован без оптимизации (флаг -O0) чтобы его было легче читать
`g++ -O0 -S math_func.cpp -o math_func.s`

В полученном файле `math_func.s` цикл `for` (метки `.L2` и `.L3`), умножения (`imulq`) и логика перехода (`jle`).
![Скриншот](fs.png)

## Лабораторная работа 2
**Ссылка** [https://disk.yandex.ru/i/saD12BWeWMvjbw](https://disk.yandex.ru/i/saD12BWeWMvjbw)
![Порты](7022.png)

## Лабораторная работа 3a
**Создание рабочей папки и тестовых файлов**
![Создание файлов](3a0.png)

**Шаг 2: Написание скрипта backup.sh**
![Скрипт bash](3a1.png)

**Шаг 3: Запуск и результат**
![Результат работы](3a2.png)

## Лабораторная работа 3b
**Создание текстовых файлов и скрипта**
![Powershell](3b1.png)
![bash](3b2.png)